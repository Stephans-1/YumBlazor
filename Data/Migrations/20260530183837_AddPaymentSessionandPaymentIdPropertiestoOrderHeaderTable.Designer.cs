...
namespace EShop.Migrations
{
    ...
    [Migration("20260530183837_AddPaymentSessionandPaymentIdPropertiestoOrderHeaderTable")]
    partial class AddPaymentSessionandPaymentIdPropertiestoOrderHeaderTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Data.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Data.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Data.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EShop.Data.OrderDetail", b =>
                {
                    b.HasOne("EShop.Data.OrderHeader", "OrderHeader")
            ...
            modelBuilder.Entity("EShop.Data.ShoppingCart", b =>
                {
                    ...
                    b.HasOne("EShop.Data.ApplicationUser", "user")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
